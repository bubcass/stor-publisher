...
// ✅ Tiptap v2 table extensions (keep all four)
...
export default function App() {
  ...
  const extensions = useMemo(
    () => [
      ...
      // ✅ Table support (keep config minimal/vanilla first)
      ...
      Placeholder.configure({
        placeholder: "Write something… or import a .docx",
      }),
      Underline,
      Highlight,
      Link.configure({
  ...
  const handleDocxSelected = async (e) => {
    ...
    try {
      ...
      // Body -> HTML (Mammoth keeps real <table> HTML)
      ...
      // Map to canonical metadata (Unit instead of Imprint); accept UnitCode or ImprintCode
      const rawUnitCode = (
        custom.UnitCode ||
        custom.ImprintCode ||
        "OTHER"
